...
class TuitionPackageModel extends BaseModel {
    ...
    async create(data) {
      ...
      INSERT INTO tuition_packages (code, name, subject_id, duration_months, sessions_per_week, price, description)
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `, [data.code, data.name, data.subject_id || null, data.duration_months, data.sessions_per_week, data.price, data.description]);
        return result;
    }
    ...
    `, [data.code, data.name, data.subject_id || null, data.duration_months,
        data.sessions_per_week, data.price, data.description, data.is_active, id]);
        return result;
    }
